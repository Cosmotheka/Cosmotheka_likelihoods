#!/bin/bash -l
echo =========================================================   
echo Job submitted  date = Sat Jan 28 14:32:11 GMT 2023      
date_start=`date +%s`
...
export OMP_NUM_THREADS=24
 nice -n 10 /mnt/zfsusers/gravityls_3/codes/xCell-likelihoods/ClLike/examples/./launch_cobaya.sh input/desy1_3x2pt.yml
